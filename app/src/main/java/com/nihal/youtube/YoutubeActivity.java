...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String GOOGLE_API_KEY = "AIzaSyDb5kFONWO1f3sZA7dlT92MBpYqoKf62Bg";
    static final String YOUTUBE_VIDEO_ID = "eTXd89t8ngI";
    static final String YOUTUBE_PLAYLIST = "PLd3UqWTnYXOmx_J1774ukG_rvrpyWczm0";
...
//        layout.addView(button1);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean wasRestored) {
        ...
        Toast.makeText(this, "Initialization Youtube Player successfully", Toast.LENGTH_SHORT).show();
